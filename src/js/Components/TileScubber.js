...
class Scrubber extends React.Component{
    render(){
        ...
        for(var itr = 0; itr < this.props.data.length; itr++){
            ...
            tiles.push(<Tile hidden={disp} number={itr+1} move={this.props.move} caption={caption} question={question} followup={followup} meme={img} discussion={discussion} revealInfoFalse={this.props.revealInfoFalse} revealInfoTrue={this.props.revealInfoTrue} reveal={this.props.reveal} answer={answer} choice={this.props.choice}/>)
        }
        return(
            <div id="Scrubber">
